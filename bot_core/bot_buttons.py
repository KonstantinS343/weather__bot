...
BUTTON_LOCATION = InlineKeyboardButton('Погода в другом городе', callback_data='location')
...
CURRENT_WEATHER = InlineKeyboardMarkup().add(BUTTON_CURRENT_WEATHER).add(BUTTON_LOCATION)
